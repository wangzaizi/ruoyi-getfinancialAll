...
# 验证总数
# 注：根据用户提供的准确列表统计，实际数量可能有变化
# 当前列表包含所有地级行政区划单位（地级市、地区、自治州、盟等）
actual_count = len(CITIES)
print(f"地级行政区划总数: {actual_count}")
